                    ...
                    <div class="card card-primary">
                        <form action="backend/editUser.php" method="POST">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputName1">Enter Username</label>
                                    <input type="text" name="username" class="form-control" value="<?php echo $userData['username']; ?>" id="exampleInputName1" placeholder="Enter Username">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="role" class="form-control">
                                        <option <?php if ($userData['role'] == 'Admin') echo 'selected'; ?>>Admin</option>
                                        <option <?php if ($userData['role'] == 'Subadmin') echo 'selected'; ?>>Subadmin</option>
                                        <option <?php if ($userData['role'] == 'Manager') echo 'selected'; ?>>Manager</option>
                                    </select>
                                </div>
                                <div class="form-group">
